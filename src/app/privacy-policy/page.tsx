                ...
                <div className="bg-white rounded-3xl shadow-lg border border-slate-100 p-8 md:p-12 space-y-10">
                    <div>
                        ...
                        <p className="text-slate-600 leading-relaxed mb-4">
                            At Zero to Hero Online and Home Tutoring Services, we collect
                    ...
                    <div>
                        ...
                        <p className="text-slate-600 leading-relaxed">
                            ...
                            or servicing you, provided those parties agree to keep this information
                    ...
                    <div>
                        ...
                        <p className="text-slate-600 leading-relaxed">
                            ...
                            is being sent. However, some parts of our website may not function
                    ...
                    <div>
                        ...
                        <p className="text-slate-600 leading-relaxed">
                            Our services are designed for students of all ages. For students under
                            18, we require parental or guardian consent before collecting personal
                            information. Parents and guardians can review, update, or delete their
                            child&apos;s information by contacting us directly.
                        </p>
                    </div>
