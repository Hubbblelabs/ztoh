            ...
            <div className="space-y-6">
                ...
                <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
                    {[1, 2, 3, 4, 5, 6].map((i) => (
                        <div
                            key={i}
                            className="bg-card rounded-lg p-6 shadow-sm border border-border flex flex-col justify-between h-48"
                        >
                    ...
                    {groups.filter(
                        ...
                        <div className="col-span-full py-12 text-center bg-muted/50 rounded-lg border border-dashed border-border">
                            ...
                            <p className="text-muted-foreground mb-6 max-w-sm mx-auto">
                                {groups.length === 0
                                    ? 'Create groups to organize students under teachers.'
                        ...
                        groups
                            ...
                            .map((group) => (
                                <div
                                    key={group._id}
                                    className="bg-background rounded-lg p-6 shadow-sm border border-border hover:shadow-md transition-shadow group relative"
                                >
                                    ...
                                    <div className="mb-4 flex flex-col gap-2 p-3 bg-muted rounded-lg">
                                        <div className="flex items-center gap-2">
                                            ...
                                            <span className="text-sm text-muted-foreground font-medium">
                                                Teachers ({group.staffIds?.length || 0})
                                            </span>
                                        </div>
                                        <div className="flex flex-wrap gap-1">
                                            {group.staffIds?.length > 0 ? (
                                                group.staffIds.map((staff) => (
                                                    <span
                                                        key={staff._id}
                                                        className="text-xs px-2 py-1 bg-card border border-border rounded-md text-foreground"
                                                    >
                                                        {staff.name}
                                                    </span>
                                                ))
                    ...
                    <div className="bg-card rounded-lg shadow-2xl w-full max-w-2xl max-h-[90vh] flex flex-col">
                            ...
                            <div>
                                ...
                                <p className="text-sm text-muted-foreground">
                                    {editingGroupId
                                        ...
                                        : 'Organize students and assign to staff'}
                                </p>
                            </div>
                            <button
                                                    ...
                                                    filteredStaff.map((staff) => (
                                                        ...
                                                        >
                                                            ...
                                                            <input
                                                                type="checkbox"
                                                                className="hidden"
                                                                checked={formData.staffIds.includes(
                                                                    staff._id,
                                                                )}
                                                                onChange={() =>
                                                                    handleStaffToggle(staff._id)
                                                                }
                                                            />
                        ...
                        <div className="p-6 border-t border-border bg-muted/50 rounded-b-2xl flex justify-end gap-3">
                            ...
                            <button
                                ...
                                disabled={
                                    submitting || !formData.name || formData.staffIds.length === 0
                                }
