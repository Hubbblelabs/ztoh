                                ...
                                <>
                                    ...
                                    >
                                        ...
                                        <button
                                            ...
                                            className={`relative flex-1 py-3.5 text-sm font-semibold rounded-xl transition-colors duration-200 z-10 flex items-center justify-center gap-2 ${
                                                activeTab === 'student'
                                                    ? 'text-slate-900'
