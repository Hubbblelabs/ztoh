                ...
                <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-12 mb-16">
                    ...
                    <div className="space-y-6">
                        ...
                        <div className="flex gap-4">
                            <Link
                                href="#"
                                className="w-10 h-10 rounded-full bg-slate-800 flex items-center justify-center hover:bg-secondary hover:text-white transition-all duration-300"
                            >
                                <Facebook size={18} />
                            </Link>
                            <Link
                    ...
                    <div>
                        ...
                        <ul className="space-y-3">
                            {['Home', 'About Us', 'Our Services', 'Testimonials', 'Contact'].map(
                                (item) => (
                                    <li key={item}>
                                        <Link
                        ...
                        <ul className="space-y-4">
                            <li className="flex items-start gap-3 group">
                                ...
                                <span className="text-sm text-slate-400 group-hover:text-white transition-colors">
                                    Zero to Hero Online and Home Tutoring Services, 9/13, Gandhi Rd,
                                    Periyar Nagar, Nehru Nagar West, East, Tamil Nadu 641014
                                </span>
                            </li>
