...
export default function CallToAction() {
    ...
    return (
        <section
            id="cta"
            className="py-28 relative overflow-hidden bg-slate-100 border-t border-slate-200"
        >
            <div className="container mx-auto px-4 md:px-6 relative z-10">
                <ScrollAnimation className="relative rounded-[3rem] overflow-hidden bg-linear-to-br from-primary via-slate-900 to-slate-800 px-6 py-10 md:px-20 md:py-16 text-center shadow-2xl">
                    {/* Enhanced Background Effects */}
                    <div className="absolute inset-0 overflow-hidden pointer-events-none">
                        <div className="absolute top-0 left-0 w-full h-full bg-[radial-gradient(circle_at_50%_0%,rgba(14,165,233,0.2),transparent_50%)]" />
                    ...
                    <div className="relative z-10 max-w-4xl mx-auto">
                        ...
                        <ScrollAnimation delay={0.1}>
                            <h2 className="text-4xl md:text-5xl lg:text-6xl font-bold font-heading text-white mb-8 leading-tight">
                                ...
                                <span
                                    className="text-transparent bg-clip-text bg-linear-to-rrom-secondary via-accent to-secondary animate-gradient-text"
                        ...
                        <ScrollAnimation delay={0.2}>
                            <p className="text-xl text-slate-300 mb-12 max-w-2xl mx-auto leading-relaxed">
                                Join thousands of students who have already taken the leap with Zero
                                to Hero. Expert guidance, personalized learning, and{' '}
                        ...
                        <ScrollAnimation delay={0.3}>
                            <div className="flex flex-col sm:flex-row gap-4 justify-center items-center">
                                ...
                                >
                                    <span className="absolute inset-0 bg-linear-to-r from-secondary/10 to-accent/10 opacity-0 group-hover:opacity-100 transition-opacity duration-300" />
                                ...
                                <div className="flex items-center gap-2">
                                    <div className="flex -space-x-1">
                                        {[...Array(4)].map((_, i) => (
                                            <div
                                                key={i}
                                                className="w-7 h-7 rounded-full bg-linear-to-br from-slate-600 to-slate-700 border-2 border-slate-800 flex items-center justify-center text-xs text-white font-medium"
                                            >
                                                {['A', 'B', 'C', 'D'][i]}
                                            </div>
                                        ))}
