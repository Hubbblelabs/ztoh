...
const services = [
    ...
    },
    {
        ...
        details:
            'Each subject studied earns an IGCSE qualification, including core subjects like First Language, Second Language, Mathematics, and Sciences.',
    },
    {
        ...
        details:
            'The mark certificates issued by the board are highly valued for further education and job opportunities.',
    },
    {
        title: 'CBSE',
...
const courseOfferings = [
    {
        ...
        groups: [
            {
                name: 'Boards',
                items: ['CBSE', 'State Board', 'IGCSE', 'IB', 'A Level'],
            },
            {
                name: 'Classes',
    ...
    },
    {
        ...
        groups: [
            {
                name: 'Entrance Tests',
                items: ['JEE', 'NEET', 'CAT', 'MAT', 'TANCET', 'CUCET JAM'],
            },
            {
                name: 'Study Abroad',
                items: ['SAT', 'GRE'],
            ...
            {
                name: 'Others',
                items: ['Deemed Universities Exams', 'Arrear Exams'],
            },
        ],
    },
    {
        ...
        groups: [
            {
                name: 'Language',
                items: ['Spoken English', 'Tamil', 'English', 'Hindi'],
            },
            {
                name: 'Interview Prep',
            ...
            },
            {
                ...
                items: ['Python', 'Java', 'Full Stack Development'],
            },
        ],
    },
];
    ...
    return (
        <section id="services" className="py-10 bg-white border-t border-slate-200 relative">
            ...
            <div className="absolute inset-0 overflow-hidden pointer-events-none">
                <div className="absolute top-1/3 left-0 w-full h-px bg-linear-to-r from-transparent via-slate-200 to-transparent" />
                <div className="absolute bottom-1/3 left-0 w-full h-px bg-linear-to-r from-transparent via-slate-200 to-transparent" />
            </div>
            ...
            <div className="container mx-auto px-4 md:px-6 relative z-10">
                ...
                <div className="text-center mb-20">
                    ...
                    <ScrollAnimation delay={0.2}>
                        <p className="text-lg text-slate-600 max-w-2xl mx-auto">
                            Comprehensive educational support tailored to your needs, from school
                            boards to competitive entrance exams.
                        </p>
                    </ScrollAnimation>
                </div>
                ...
                <div className="relative mb-24 group overflow-hidden">
                            ...
                            {[...services, ...services].map((service, index) => (
                                ...
                                >
                                    ...
                                    <div className="grow overflow-hidden relative">
                                        ...
                                        <div className="absolute bottom-0 left-0 w-full h-8 bg-linear-to-t from-white to-transparent" />
                                    </div>
                                    <div className="mt-4 flex items-center gap-2 text-primary font-semibold text-sm hover:gap-3 transition-all group/btn">
                                        Read More
                                        <ArrowRight
                                            size={16}
                    ...
                    {/* Fade edges */}
                    <div className="absolute top-0 right-0 h-full w-24 bg-linear-to-l from-slate-50 to-transparent pointer-events-none z-10" />
                    <div className="absolute top-0 left-0 h-full w-24 bg-linear-to-r from-slate-50 to-transparent pointer-events-none z-10" />
                </div>
                    ...
                    <div className="relative z-10 p-8 md:p-20 text-white">
                        <div className="text-center mb-16">
                            ...
                            <p className="text-slate-400 text-lg">
                                Explore our wide range of subjects and classes
                            </p>
                        </div>
                                                ...
                                                <div key={idx}>
                                                    ...
                                                    <div className="flex flex-wrap gap-2">
                                                        {group.items.map((item, i) => (
                                                            <span
                                                                key={i}
                                                                className="px-3 py-1 rounded-full bg-white/5 text-slate-300 text-sm border border-white/5 hover:bg-white/10 hover:border-white/10 transition-colors cursor-default"
                                                            >
                                                                {item}
                                                            </span>
                                                        ))}
