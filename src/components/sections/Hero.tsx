            ...
            <div className="container mx-auto px-4 md:px-6 relative z-10">
                <div className="flex flex-col lg:flex-row items-center gap-12 lg:gap-20">
                    ...
                    >
                        <motion.div
                            variants={fadeInUp}
                            className="inline-flex items-center gap-2 px-4 py-2 rounded-full bg-white border border-slate-200 shadow-sm text-slate-600 text-sm font-semibold mb-8 hover:scale-105 transition-transform cursor-default"
                        >
                        ...
                        <motion.h1
                            variants={fadeInUpImmediate}
                            className="text-5xl md:text-6xl lg:text-7xl font-bold font-heading text-slate-900 leading-[1.1] mb-6 tracking-tight"
                        >
                            Welcome to{' '}
                            <span className="text-transparent bg-clip-text bg-linear-to-r from-slate-700 to-slate-900">
                                Zero
                            </span>{' '}
                            to{' '}
                        ...
                        >
                            Unlock your full potential with our expert-led mentorship and
                            personalized tutoring. We bridge the gap between where you are and where
                            you want to be.
                        </motion.p>
                        ...
                        <motion.div
                            variants={fadeInUp}
                            className="flex items-center justify-center lg:justify-start gap-8 text-sm font-semibold text-slate-500"
                        >
                    ...
                    >
                        <div className="relative z-10 bg-white rounded-[2.5rem] p-4 shadow-2xl shadow-slate-200/50 border border-slate-100 transform rotate-2 hover:rotate-0 transition-transform duration-500">
                            <div className="relative aspect-4/3 rounded-4xl overflow-hidden bg-slate-900">
                                <div className="absolute inset-0 bg-linear-to-br from-slate-900 via-primary to-slate-800">
                        ...
                        >
                            <div className="glass p-4 rounded-2xl shadow-lg border border-white/50 flex items-center gap-3">
                                ...
                                <div>
                                    ...
                                    <div className="text-lg font-bold text-slate-800">99.99%</div>
                                </div>
                            </div>
                        </motion.div>
