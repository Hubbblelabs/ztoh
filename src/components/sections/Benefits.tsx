            ...
            <div className="container mx-auto px-4 md:px-6">
                <div className="text-center mb-16">
                    ...
                    <p className="text-lg text-slate-600 max-w-2xl mx-auto">
                        Choose the mode of learning that fits your lifestyle and goals. We offer
                        both flexible online classes and focused home-based sessions.
                    </p>
                </div>

                <div className="flex overflow-x-auto pb-8 gap-6 snap-x snap-mandatory -mx-4 px-4 lg:mx-0 lg:px-0 lg:grid lg:grid-cols-2 lg:gap-12 lg:pb-0 lg:overflow-visible scrollbar-hide">
                    {/* Online Classes */}
                    <motion.div
                        initial={{ opacity: 0, x: -20 }}
                        whileInView={{ opacity: 1, x: 0 }}
                        viewport={{ once: true }}
                        className="bg-white rounded-3xl p-8 shadow-lg border border-slate-100 min-w-[85vw] md:min-w-[500px] lg:min-w-0 snap-center"
                    >
