            ...
            <div className="container mx-auto px-4 md:px-6 relative z-10">
                <div className="flex flex-col lg:flex-row gap-16 lg:gap-24 items-center mb-24">
                    ...
                    <div className="w-full lg:w-5/12 relative">
                        <ScrollAnimation variants={{ hidden: { opacity: 0, x: -20 }, visible: { opacity: 1, x: 0 } }}>
                            <div className="relative z-10 rounded-[2.5rem] overflow-hidden shadow-2xl border-8 border-white group">
                                ...
                                <div className="absolute bottom-0 left-0 w-full p-8 translate-y-4 group-hover:translate-y-0 transition-transform duration-300">
                                    <div className="flex items-center gap-4 mb-2">
                                        ...
                                        <p className="text-secondary font-bold tracking-wider uppercase text-sm">Founder</p>
                                    </div>
                    ...
                    <div className="w-full lg:w-7/12">
                        <ScrollAnimation>
                            ...
                            <h2 className="text-4xl md:text-5xl font-bold font-heading text-slate-900 mb-8 leading-tight">
                                Meet the <span className="animated-gradient-text font-extrabold pb-2 inline-block">Founder</span>
                            </h2>
                            
                            <div className="space-y-6 text-lg text-slate-600 leading-relaxed font-medium">
                                <p>
                                    Hi, This is <span className="font-bold text-slate-900">MuthuKumar</span>, 
                                ...
                                <p className="p-6 bg-white rounded-2xl border border-slate-100 shadow-sm relative overflow-hidden group">
                                    ...
                                    I hold a Master of Philosophy degree in Mathematics and possess extensive 
                                    experience in teaching mathematics to engineering graduates and students from 
                                    various school boards, including <strong className="text-primary font-bold">IB, IGCSE, CBSE, and the State Board</strong> of 
                                    the Indian curriculum.
                                </p>
                                <p>
                                    I have gained valuable expertise in teaching the syllabi of different countries 
                                    such as the US, the UK, and Saudi Arabia. Also, I am well-versed in preparing 
                                    students for competitive exams such as SSAT (Middle and Upper Level), SSC, 
                                    IIT-JEE Mains, SAT, GATE, Management (MAT, CAT, TANCET), as well as Deemed 
                ...
                <div className="grid grid-cols-1 lg:grid-cols-2 gap-8">
                    ...
                    <ScrollAnimation delay={0.1}>
                        <div className="h-full bg-white p-8 md:p-10 rounded-4xl shadow-lg shadow-slate-200/50 border border-slate-100 relative overflow-hidden group hover:border-secondary/30 transition-all duration-300">
                            ...
                            <div className="flex items-center gap-5 mb-8 relative z-10">
                                ...
                                <div>
                                    <h3 className="text-3xl font-bold font-heading text-slate-900 group-hover:text-blue-600 transition-colors">Our Vision</h3>
                                </div>
                            </div>
                    ...
                    {/* Mission */}
                    <ScrollAnimation delay={0.2} variants={{ hidden: { opacity: 0, y: 20 }, visible: { opacity: 1, y: 0 } }}>
                        <div className="h-full bg-slate-900 p-8 md:p-10 rounded-4xl shadow-xl shadow-slate-900/20 border border-slate-800 relative overflow-hidden group hover:border-accent/30 transition-all duration-300">
                            ...
                            <div className="flex items-center gap-5 mb-8 relative z-10">
                                ...
                                <div>
                                    <h3 className="text-3xl font-bold font-heading text-white group-hover:text-accent transition-colors">Our Mission</h3>
                                </div>
                            </div>
                            ...
                            <div className="text-slate-300 relative z-10 flex flex-col gap-4">
                                {[
                                    ...
                                    <div key={index} className="flex gap-4 p-4 rounded-xl bg-white/5 border border-white/10 hover:bg-white/10 hover:border-white/20 transition-colors">
