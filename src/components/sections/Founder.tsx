                ...
                <div className="flex flex-col lg:flex-row gap-12 lg:gap-20 items-start">
                    ...
                    >
                        <div className="relative rounded-3xl overflow-hidden shadow-2xl border-4 border-white">
                            ...
                            />
                            <div className="absolute bottom-0 left-0 w-full bg-linear-to-t from-slate-900 to-transparent p-8 pt-24">
                                <h3 className="text-2xl font-bold text-white font-heading">
                                    MuthuKumar
                                </h3>
                                <p className="text-secondary font-medium">Founder</p>
                            </div>
                        </div>
                        ...
                        >
                            ...
                            <div className="prose prose-lg text-slate-600 leading-relaxed">
                                <p>
                                    ...
                                    Tutoring Services&quot;, Coimbatore. I hold a Master of
                                    Philosophy degree in Mathematics and possess extensive
                                    experience in teaching mathematics to engineering graduates and
                                    students from various school boards, including IB, IGCSE, CBSE,
                                    and the State Board of the Indian curriculum.
                                </p>
                                <p className="mt-4">
                                    I have gained valuable expertise in teaching the syllabi of
                                    different countries such as the US, the UK, and Saudi Arabia
                                    too. Also, I am well-versed in preparing students and trainers
                                    for competitive exams such as SSAT (Middle and Upper Level),
                                    SSC, IIT-JEE Mains, SAT, GATE, Management (MAT, CAT, TANCET), as
                                    well as Deemed Universities Engineering Entrance Exams.
                                </p>
                            </div>
                        </motion.div>
                            ...
                            >
                                ...
                                <ul className="space-y-3 text-slate-600">
                                    <li className="flex gap-3">
                                        ...
                                        Revolutionize the education system by focusing on
                                        understanding, personalized learning, and practical
                                        application.
                                    </li>
                                    <li className="flex gap-3">
                                        <span className="w-1.5 h-1.5 rounded-full bg-blue-500 mt-2.5 shrink-0"></span>
                                        Create a dynamic learning environment that ignites curiosity
                                        and passion.
                                    </li>
                                    <li className="flex gap-3">
                                        <span className="w-1.5 h-1.5 rounded-full bg-blue-500 mt-2.5 shrink-0"></span>
                                        Move away from rote memorization and cultivate a deep
                                        understanding of subjects.
                                    </li>
                                    <li className="flex gap-3">
                                        <span className="w-1.5 h-1.5 rounded-full bg-blue-500 mt-2.5 shrink-0"></span>
                                        Employ skilled teachers who encourage critical thinking and
                                        practical skills for student development.
                                    </li>
                                    <li className="flex gap-3">
                                        <span className="w-1.5 h-1.5 rounded-full bg-blue-500 mt-2.5 shrink-0"></span>
                                        Foster holistic learning to equip students for success in a
                            ...
                            >
                                ...
                                <div className="grid grid-cols-1 md:grid-cols-2 gap-6 text-slate-600">
                                    <ul className="space-y-4">
                                        ...
                                        <li className="flex gap-3">
                                            <span className="w-1.5 h-1.5 rounded-full bg-green-500 mt-2.5 shrink-0"></span>
                                            Ensure equal educational opportunities to all
                                            individuals.
                                        </li>
                                        <li className="flex gap-3">
                                            <span className="w-1.5 h-1.5 rounded-full bg-green-500 mt-2.5 shrink-0"></span>
                                    ...
                                    <ul className="space-y-4">
                                        <li className="flex gap-3">
                                            <span className="w-1.5 h-1.5 rounded-full bg-green-500 mt-2.5 shrink-0"></span>
                                            Foster interest in subjects through real-life
                                            application-based teaching methods.
                                        </li>
                                        <li className="flex gap-3">
                                            <span className="w-1.5 h-1.5 rounded-full bg-green-500 mt-2.5 shrink-0"></span>
                                            Deliver high-quality teachers directly to your location
                                            or through device.
                                        </li>
                                        <li className="flex gap-3">
                                            <span className="w-1.5 h-1.5 rounded-full bg-green-500 mt-2.5 shrink-0"></span>
